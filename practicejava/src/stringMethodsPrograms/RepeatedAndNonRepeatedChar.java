...
public class RepeatedAndNonRepeatedChar {
	...
	/*  write a java program to find first repeated and  first non repeated characters in the given string
	 * 
	 * input : java is easy;
	 * 
	 * output : first repeated character is  : a  and firt non repeated character is : j
	 * 
	 * 
	 */
